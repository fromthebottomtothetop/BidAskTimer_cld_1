...
def calculate_layout(cfg: AppConfig, state: AppState) -> dict:
    ...
    # Advanced modal
    #
    #  +45   Row 1: Always on Top | Header
    #  +85   Row 2: Show CPU      | Round Corners
    # +125   Row 3: Ampel+Stale   | Crypto Mode
    # +165   Row 4: Scale-Mode cycling button (full width)
    # +210   Row 5: Fixed Max input  (label + field)
    # +270   inp_lerp
    # +330   inp_buff
    # +390   inp_width
    # bottom-45: Save / Cancel
    #
    # Hoehe: 460px
    # ------------------------------------------------------------------
    adv_w, adv_h = 260, 460
    ...
    # Row 4: Scale-Mode cycling button (ein Klick = naechster Modus)
    r["btn_adv_scale"]  = pygame.Rect(adv_rect.x + 15,             adv_rect.y + 165, full_btn, 30)
    # Row 5: Fixed Scale Max input
    ...
    r["adv_cancel"] = pygame.Rect(adv_rect.x + 20 + (adv_w - 50) // 2 + 10,
                                  adv_rect.bottom - 45, (adv_w - 50) // 2, 30)
